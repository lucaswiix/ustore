...
<spring:bind path="grupo">
                <div class="input-group mb-3 ${status.error ? 'has-error' : ''}">
                  <div class="input-group-prepend" style="width:30%;min-width: 75px;">
                    <label class="input-group-text" for="grupo" style="width: 100%;" >Group:</label>
                  </div>
...
<spring:bind path="area">
               <div class="input-group mb-3 ${status.error ? 'has-error' : ''}">
                  <div class="input-group-prepend" style="width:30%;min-width: 75px;">
                    <label class="input-group-text" style="width: 100%;" for="area">To area:</label>
                  </div>
      ...
      <a href="/panel/saruman">
        ...
        <button type="submit" class="float-right btn btn-success">Send Msg</button>
