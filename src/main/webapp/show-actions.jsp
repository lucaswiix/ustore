...
<div style="max-width: 300px;position: fixed;bottom:20px;right:20px;align-items: center;">
  ...
  <div class="menu row" style="width: 100%;height: 150px;border-top:solid 1px #ccc;border-bottom: solid 2px #ccc;margin:20px 0px 20px 0px;">
   ...
   <button type="button" class="menua col-md-3 col-sm-4 col-xs-6" style="font-size:1.4em;color:#444;font-weight:500;height: 150px;border:none;background-color:#F0AD4E;" onclick="window.location='/new/order';">
    ...
    <button type="button" class="active-menu menua col-md-3 col-sm-4 col-xs-6" style="font-size:1.4em;color:#444;font-weight:500;height: 150px;border:none;background-color:#5BC0DE;" onclick="window.location='/new/action';">
    Actions     
   </button> 
...
<hr>
  ...
  <div style="height: 50px;background-color:#ccc;"><center><h1>Actions orders</h1></center></div>
    ...
    <div class="row">
     ...
     <c:forEach items="${actions}" var="actions">
          <div class="col-md-3 col-sm-4 col-xs-6 p-2" >
            <div class="card">
              <div class="card-body">
                <h6 class="card-subtitle mb-2 text-muted">To soldier number ${actions.soldierId}</h6>
                <p class="card-text">
                  <table width="100%">
                    <tr>
                      <td><b>Go to group</b></td><td>${actions.grupo}</td>                      
                    </tr>
                    <tr>
                      <td><b>Travel to</b></td><td>${actions.area}</td>                      
                    </tr>
                  </table>
                </p>
              </div>
              ...
              <c:choose>
                <c:when test="${actions.exec == true}">
                <button type="button" style="margin-bottom:10px;" class="btn btn-success btn-block" disabled><i class="fas fa-check"></i> Done!</button>
                </c:when> 
                <c:otherwise>
                <button type="button" style="margin-bottom:10px;" class="btn btn-info btn-block" disabled>Not performed</button>
               </c:otherwise>
             </c:choose>
